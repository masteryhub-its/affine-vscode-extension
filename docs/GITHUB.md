...
4. Sideload releases: tag `v<version>`, run `npm run package`, attach `affine-<version>.vsix` to a GitHub Release.

## Optional later

- Open VSX and VS Marketplace publisher `masteryhub-its` (see [ROADMAP.md](../ROADMAP.md) v1.0)
