...
[![CI](https://github.com/MasteryHub-ITS/affine-vscode/actions/workflows/ci.yml/badge.svg)](https://github.com/MasteryHub-ITS/affine-vscode/actions/workflows/ci.yml)
[![GitHub stars](https://img.shields.io/github/stars/MasteryHub-ITS/affine-vscode?style=social)](https://github.com/MasteryHub-ITS/affine-vscode/stargazers)
...
1. **Bug** — [open a bug report](https://github.com/MasteryHub-ITS/affine-vscode/issues/new?template=bug_report.yml) with extension version, editor, server URL (no tokens), and what happened.
2. **Feature** — [open a feature request](https://github.com/MasteryHub-ITS/affine-vscode/issues/new?template=feature_request.yml). Describe the problem, then a proposal. Open an issue before large changes so we can agree on shape.
...
1. Download the `.vsix` from [Releases](https://github.com/MasteryHub-ITS/affine-vscode/releases), or run `npm run package` in this repo.
